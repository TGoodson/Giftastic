// create an array of Monsters - in this case, monsters
var shows = ["Godzilla", "King Kong", "King Ghidorah", "Mechagodzilla", "Mothra", "SpaceGodzilla", "MUTO", "Minilla"];
...
$("#addShow").on("click", function(){
	...
	shows.push(show);
	// the makeButtons function is called, which makes buttons for all my monsters plus the user show
	makeButtons();
